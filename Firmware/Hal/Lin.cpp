...
static constexpr const uint8_t LinMaxAnswerSize = 8;
...
#if 0
	module->autoAnswer[0].id = 0x2A;
	module->autoAnswer[0].size = 8;
	module->autoAnswer[0].data[0] = 0x08;
	module->autoAnswer[0].data[1] = 0x07;
	module->autoAnswer[0].data[2] = 0x06;
	module->autoAnswer[0].data[3] = 0x05;
	module->autoAnswer[0].data[4] = 0x04;
	module->autoAnswer[0].data[5] = 0x03;
	module->autoAnswer[0].data[6] = 0x02;
	module->autoAnswer[0].data[7] = 0x01;
#endif
...
void linAutoAnswer( Module* const module, const uint8_t linId ){
...
void linAutoAnswerCheck( Module* const module ){
...
void linCompleteRx( Module* const module ){
	...
	if ( InvalidIndex != p ) {
		...
		// So, now I am ready to send packet to the USB
		linAutoAnswerCheck(module);
		// Send frame to USB
